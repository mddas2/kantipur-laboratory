            ...
            <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; font-family: Poppins; background: whitesmoke; padding: 20px; border-radius: 6px;">
                <tr>
                    <td align="center" bgcolor="#FFFFFF" style="padding: 20px;">
                        ...
                        <p style="text-align: center; font-weight: 400;">Your test for <span style="font-weight: 600;">{instance.name} (Reference Number: {instance.refrence_number})</span> is completed successfully. Please click here to view your report.</p>
