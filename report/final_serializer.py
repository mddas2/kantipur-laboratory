...
class CompletedSampleFormHasVerifierSerializer_User(serializers.ModelSerializer):
    ...
    class Meta:
        name = "CompletedSampleFormHasVerifierSerializer_report_"
        model = SampleForm
        fields = ['id','supervisor_sample_form','name','supervisor_user','sample_has_parameter_analyst','commodity','status','created_date','completed_date','client_category_detail','namuna_code','mfd','dfb','sample_quantity','sample_units','voucher_number','voucher_date','analysis_fee','parameters'] #user access
