...
urlpatterns = [   
    ...
    path('final-report-sample-form/', final_report.FinalSampleFormReportAPIView.as_view()), #FinalSampleFormHasVerifiedAPIView #accessable to all superadmin,user
    ...
    path('dashboard-report/<int:user_id>/', dashboard.ProfileReportStatus.as_view()),
