...
class CompletedSampleFormHasVerifierAPIView(generics.ListAPIView): #blunder md , permission fixed
    ...
    pagination_class = MyPageNumberPagination
    filter_backends = [SearchFilter,DjangoFilterBackend,OrderingFilter]
    search_fields = ['id','name','owner_user_obj__username','status','form_available','commodity__name','namuna_code','code']
...
class notApprovedSampleFormHasAdminAPIView(generics.ListAPIView):
    ...
    filter_backends = [SearchFilter,DjangoFilterBackend,OrderingFilter]
    search_fields = ['id','name','status','form_available','commodity__name','namuna_code']
    ordering_fields = ['id']
    filterset_fields = {
        'name': ['exact', 'icontains'],
        'status': ['exact'],
