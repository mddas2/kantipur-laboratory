    ...
    def to_representation(self, instance):
        ...
        for parameter_data in parameters_data:
            ...
            if exists:
                ...
                parameter_data['sup_full_name'] = str(analyst_obj.super_visor_sample_form.supervisor_user.first_name)+" "+ str(analyst_obj.super_visor_sample_form.supervisor_user.last_name)#blundermd
